...
const DownloadStorageWarning: React.FC<DownloadStorageWarningProps> = ({
  onOpenSettings,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          The saved download location is not available. This often means an
          external drive is disconnected. Your download queue has been preserved
          and downloading is paused.
        </div>
        <div
          style={{
            margin: "18px 0 10px",
