...
export interface IPCChannels {
	...
	"adb:connect-tcp-device": DefineChannel<
		[ipAddress: string, port?: number],
		boolean
	>;
	"adb:disconnect-tcp-device": DefineChannel<
		[ipAddress: string, port?: number],
		boolean
	>;
	...
	"adb:uninstallPackage": DefineChannel<
		[serial: string, packageName: string],
		boolean
	>;
	...
	>;
	"adb:get-application-label": DefineChannel<
		[serial: string, packageName: string],
		string | null
	>;
	...
	>;
	"adb:run-shell-command": DefineChannel<
		[serial: string, command: string],
		string | null
	>;
	...
	"games:add-to-blacklist": DefineChannel<
		[packageName: string, version?: number | "any"],
		boolean
	>;
	"games:remove-from-blacklist": DefineChannel<[packageName: string], boolean>;
	"games:is-game-blacklisted": DefineChannel<
		[packageName: string, version?: number],
		boolean
	>;
	...
	"download:install-from-completed": DefineChannel<
		[releaseName: string, deviceId: string],
		void
	>;
	...
	"upload:add-to-queue": DefineChannel<
		...
		boolean
	>;
	"upload:add-local-items": DefineChannel<
		[paths: string[]],
		{ errors: LocalUploadError[] }
	>;
	...
	"settings:get-existing-download-action": DefineChannel<
		[],
		ExistingDownloadAction
	>;
	"settings:set-existing-download-action": DefineChannel<
		[v: ExistingDownloadAction],
		void
	>;

	// Log upload related channels
	"logs:upload-current": DefineChannel<
		[],
		{ url: string; password: string; slug: string } | null
	>;
	...
	"wifi-bookmarks:add": DefineChannel<
	...
	"downloads:install-manual": DefineChannel<
		[filePath: string, deviceId: string],
		boolean
	>;
	"downloads:copy-obb-folder": DefineChannel<
		[folderPath: string, deviceId: string],
		boolean
	>;
	...
	"backup:set-verification": DefineChannel<
		...
		BackupEntry | null
	>;
	"backup:report-failure": DefineChannel<
		[backupId: string],
		BackupReportResult | null
	>;
	"backup:get-profile": DefineChannel<
		[packageName: string],
		BackupProfile | null
	>;
}
